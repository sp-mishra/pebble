...
TEST_CASE("recovery_makes_progress_v: skip_until_sync → true",
          "[samasa][conformance][recovery]")
{
    STATIC_REQUIRE(recovery_makes_progress_v<skip_until_sync<MySyncSet>>);
}

TEST_CASE("recovery_makes_progress_v: insert_missing_token → true",
          "[samasa][conformance][recovery]")
{
    STATIC_REQUIRE(recovery_makes_progress_v<insert_missing_token<TK::tok_semi>>);
}

TEST_CASE("recovery_makes_progress_v: delete_unexpected → true",
          "[samasa][conformance][recovery]")
{
    STATIC_REQUIRE(recovery_makes_progress_v<delete_unexpected>);
}

TEST_CASE("recovery_makes_progress_v: wrap_error_node → false",
          "[samasa][conformance][recovery]")
{
...
TEST_CASE("has_no_progress_recovery: progressing recovery → false",
          "[samasa][conformance][recovery]")
{
...
TEST_CASE("grammar_valid: recovery_no_progress code is error-severity",
          "[samasa][conformance][recovery]")
{
...
TEST_CASE("recover_with: hard-fail → recovery runs, parse continues, diagnostic emitted",
          "[samasa][conformance][recovery]")
{
