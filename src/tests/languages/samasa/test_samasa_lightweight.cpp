...
namespace {
    ...
    using choice_rule = lang::samasa::rule<"root", lang::samasa::choice_t <
                                           lang::samasa::tok < tk::alpha>
    ,
    lang::samasa::tok<tk::beta>
    >
    >;
    using choice_grammar = lang::samasa::grammar<sk, tk, choice_rule, choice_rule>;
    constexpr lang::samasa::scan_token_kinds<tk> kinds{
        tk::eof, tk::ident, tk::integer, tk::floating, tk::string, tk::unknown
    };
    using words = lang::samasa::keyword_table<lang::samasa::keyword < "alpha", tk::alpha>
    ,
    lang::samasa::keyword<"beta", tk::beta>
    >;
}

TEST_CASE (
"samasa lightweight: cached metadata and predicted token choice"
,
"[samasa][lightweight]"
)
 {
...
TEST_CASE (
"samasa lightweight: direct event parse omits CST materialization"
,
"[samasa][lightweight]"
)
 {
...
TEST_CASE (
"samasa lightweight: dense memo has no allocation path"
,
"[samasa][lightweight]"
)
 {
