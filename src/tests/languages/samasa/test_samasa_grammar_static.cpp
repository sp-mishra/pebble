...
namespace {
    ...
    using root_pattern = seq_t<tok < MyTK::kw_let>
    ,
    tok<MyTK::ident>
    ,
    tok<MyTK::op_eq>
...
TEST_CASE (
"grammar_valid: valid grammar passes static check"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: syntax_kind / token_kind aliases"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: root_rule type matches"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: rules TypeList has exactly one type"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: seq of non-nullable matchers is not empty_many"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: validate_grammar detects empty_many"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: validate_grammar detects duplicate_rule"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: validate_grammar returns ok for valid grammar"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: grammar_diag_code enum has 7 values"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: require_valid_grammar compiles for valid grammar (no-op)"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: operator_table_valid — valid table returns true"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: operator_table_valid_check — duplicate ops detected via detail trait"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: nullable_v — tok<K> is not nullable"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: nullable_v — opt<P> is nullable"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: nullable_v — many<P> is nullable (zero repetitions allowed)"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: nullable_v — seq of non-nullable is not nullable"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: grammar_fingerprint is nonzero for valid grammar"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: grammar_fingerprint is deterministic — two calls return same value"
,
"[samasa][grammar]"
)
 {
...
TEST_CASE (
"grammar: grammar_fingerprint differs for grammars with different rule names"
,
"[samasa][grammar]"
)
 {
