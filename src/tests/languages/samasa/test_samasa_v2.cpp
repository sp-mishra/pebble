...
namespace {
    ...
    using expr_rule = rule<"expr", choice_t < tok < TK::ident>
    ,
    tok<TK::op_plus>
    >
    >;
    using root_rule = rule<"root", seq_t < tok < TK::kw_let>
    ,
    tok<TK::ident>
    ,
    tok<TK::op_eq>
...
TEST_CASE (
"expected_at: choice<A,B> returns FIRST(A) ∪ FIRST(B)"
,
"[samasa][v2][first]"
)
 {
...
TEST_CASE (
"expected_at: seq<A,B> returns FIRST(A) only when A non-nullable"
,
"[samasa][v2][first]"
)
 {
...
TEST_CASE (
"first_sets: returns grammar_first_sets with correct rule count"
,
"[samasa][v2][first]"
)
 {
...
TEST_CASE (
"first_sets: nullable flag correct for non-nullable root"
,
"[samasa][v2][first]"
)
 {
...
namespace {
    ...
    using bad_sep_pat = sep_by_t<tok < TK::ident>
    ,
    opt_t<tok<TK::semi>>
    >;
...
TEST_CASE (
"validation v2: empty_separator detected"
,
"[samasa][v2][validation]"
)
 {
...
TEST_CASE (
"validation v2: choice_shadowing detected"
,
"[samasa][v2][validation]"
)
 {
...
TEST_CASE (
"validation v2: grammar_diag_code has nullable_root and choice_shadowing"
,
"[samasa][v2][validation]"
)
 {
...
TEST_CASE (
"validation v2: detail::has_empty_sep detects nullable separator"
,
"[samasa][v2][validation]"
)
 {
...
TEST_CASE (
"validation v2: detail::has_shadowed_choice detects nullable first alternative"
,
"[samasa][v2][validation]"
)
 {
...
TEST_CASE (
"validation v2: no_empty_sep_check passes for normal sep_by"
,
"[samasa][v2][validation]"
)
 {
...
TEST_CASE (
"trace_policy: no_trace has enabled=false"
,
"[samasa][v2][trace]"
)
 {
...
TEST_CASE (
"trace_policy: collecting_trace has enabled=true"
,
"[samasa][v2][trace]"
)
 {
...
TEST_CASE (
"trace_policy: collecting_trace accumulates events"
,
"[samasa][v2][trace]"
)
 {
...
TEST_CASE (
"trace_policy: collecting_trace records fail event"
,
"[samasa][v2][trace]"
)
 {
...
TEST_CASE (
"trace_policy: collecting_trace records hard_fail"
,
"[samasa][v2][trace]"
)
 {
...
TEST_CASE (
"trace_policy: collecting_trace clear() works"
,
"[samasa][v2][trace]"
)
 {
...
TEST_CASE (
"trace_policy: no_trace on_event is constexpr no-op"
,
"[samasa][v2][trace]"
)
 {
...
TEST_CASE (
"diagnostic: samasa_diag_code has recover_replace and recover_wrap_subtree"
,
"[samasa][v2][diag]"
)
 {
...
TEST_CASE (
"diagnostic: to_code maps new codes"
,
"[samasa][v2][diag]"
)
 {
...
TEST_CASE (
"diagnostic: expected_item kinds"
,
"[samasa][v2][diag]"
)
 {
...
TEST_CASE (
"diagnostic: parse_diagnostic add_expected respects MaxExpected"
,
"[samasa][v2][diag]"
)
 {
...
TEST_CASE (
"diagnostic: repair_cost values match design spec"
,
"[samasa][v2][diag]"
)
 {
...
TEST_CASE (
"memo_policy: no_memo has enabled=false"
,
"[samasa][v2][memo]"
)
 {
...
TEST_CASE (
"memo_policy: no_memo lookup always returns false"
,
"[samasa][v2][memo]"
)
 {
...
TEST_CASE (
"memo_policy: selective_memo has enabled=true"
,
"[samasa][v2][memo]"
)
 {
...
TEST_CASE (
"memo_policy: selective_memo store/lookup round-trips"
,
"[samasa][v2][memo]"
)
 {
...
TEST_CASE (
"memo_policy: selective_memo miss returns false"
,
"[samasa][v2][memo]"
)
 {
...
TEST_CASE (
"memo_policy: packrat_memo store/lookup round-trips"
,
"[samasa][v2][memo]"
)
 {
...
TEST_CASE (
"memo_policy: memo_key_hash distributes keys"
,
"[samasa][v2][memo]"
)
 {
...
TEST_CASE (
"railroad: railroad_model returns grammar_railroad_model with correct count"
,
"[samasa][v2][railroad]"
)
 {
...
TEST_CASE (
"railroad: railroad_rule_entry shape for seq is 'sequence'"
,
"[samasa][v2][railroad]"
)
 {
...
TEST_CASE (
"railroad: railroad_rule_entry nullable correct"
,
"[samasa][v2][railroad]"
)
 {
...
TEST_CASE (
"railroad: render_markdown produces non-empty string"
,
"[samasa][v2][railroad]"
)
 {
...
TEST_CASE (
"railroad: render_markdown railroad produces table"
,
"[samasa][v2][railroad]"
)
 {
...
TEST_CASE (
"railroad: render_json grammar produces valid JSON prefix"
,
"[samasa][v2][railroad]"
)
 {
...
TEST_CASE (
"railroad: render_json railroad produces rules array"
,
"[samasa][v2][railroad]"
)
 {
...
TEST_CASE (
"railroad: render_json first_sets produces first_sets array"
,
"[samasa][v2][railroad]"
)
 {
...
TEST_CASE (
"fingerprint: green_fingerprint default is invalid"
,
"[samasa][v2][fingerprint]"
)
 {
...
TEST_CASE (
"fingerprint: green_fingerprint equality"
,
"[samasa][v2][fingerprint]"
)
 {
...
TEST_CASE (
"fingerprint: green_fingerprint inequality"
,
"[samasa][v2][fingerprint]"
)
 {
...
TEST_CASE (
"fingerprint: green_fingerprint valid when grammar_hash and source_hash nonzero"
,
"[samasa][v2][fingerprint]"
)
 {
...
TEST_CASE (
"scanner: scanner_mode_stack default mode is k_scanner_mode_default"
,
"[samasa][v2][scanner]"
)
 {
...
TEST_CASE (
"scanner: push_mode / pop_mode work correctly"
,
"[samasa][v2][scanner]"
)
 {
...
TEST_CASE (
"scanner: pop_mode on empty stack is safe"
,
"[samasa][v2][scanner]"
)
 {
...
TEST_CASE (
"scanner: unicode_identifier_policy ASCII defaults"
,
"[samasa][v2][scanner]"
)
 {
...
TEST_CASE (
"incremental: apply_edit insert at start"
,
"[samasa][v2][incremental]"
)
 {
...
TEST_CASE (
"incremental: apply_edit delete middle"
,
"[samasa][v2][incremental]"
)
 {
...
TEST_CASE (
"incremental: apply_edit replace"
,
"[samasa][v2][incremental]"
)
 {
...
TEST_CASE (
"incremental: apply_edit no change"
,
"[samasa][v2][incremental]"
)
 {
...
TEST_CASE (
"incremental: incremental_stats default is zero"
,
"[samasa][v2][incremental]"
)
 {
...
TEST_CASE (
"incremental: diff_trees on empty outputs produces zero reuse"
,
"[samasa][v2][incremental]"
)
 {
...
TEST_CASE (
"conformance: grammar_issue_severity enum values"
,
"[samasa][conformance][validation]"
)
 {
...
TEST_CASE (
"conformance: grammar_diag_code::choice_first_overlap == 10"
,
"[samasa][conformance][validation]"
)
 {
...
TEST_CASE (
"conformance: validate_grammar detects choice_first_overlap as warning"
,
"[samasa][conformance][validation]"
)
 {
...
TEST_CASE (
"conformance: validate_grammar ok() ignores warnings"
,
"[samasa][conformance][validation]"
)
 {
...
TEST_CASE (
"conformance: grammar_valid<G> is pure predicate — no static_assert side effects"
,
"[samasa][conformance][validation]"
)
 {
...
TEST_CASE (
"conformance: grammar_validation_issue severity field defaults to error"
,
"[samasa][conformance][validation]"
)
 {
...
TEST_CASE (
"conformance: follow_sets<G> returns grammar_follow_sets with rule_count entries"
,
...
TEST_CASE (
"conformance: follow_of<G,Rule> root rule has eof sentinel"
,
"[samasa][conformance][follow]"
)
 {
...
TEST_CASE (
"conformance: follow_of<G,Rule> non-root contains continuation tokens"
,
"[samasa][conformance][follow]"
)
 {
...
TEST_CASE (
"conformance: expected_after<G,Rule> is FIRST ∪ FOLLOW"
,
"[samasa][conformance][follow]"
)
 {
...
TEST_CASE (
"conformance: recovery_makes_progress_v<skip_until_sync> is true"
,
...
TEST_CASE (
"conformance: recovery_makes_progress_v<insert_missing> is true"
,
"[samasa][conformance][recovery]"
)
 {
...
TEST_CASE (
"conformance: recovery_makes_progress_v<delete_unexpected> is true"
,
"[samasa][conformance][recovery]"
)
 {
...
TEST_CASE (
"conformance: recovery_makes_progress_v<wrap_error_node> is false"
,
"[samasa][conformance][recovery]"
)
 {
...
TEST_CASE (
"conformance: FIRST seq nullable propagation"
,
...
TEST_CASE (
"conformance: FIRST many<X> = FIRST<X>"
,
"[samasa][conformance][first]"
)
 {
...
TEST_CASE (
"conformance: FIRST opt<X> = FIRST<X>"
,
"[samasa][conformance][first]"
)
 {
...
TEST_CASE (
"conformance: print_original on empty token buffer returns empty string"
,
"[samasa][conformance][incremental]"
)
 {
    green_tree<SK>  tree;
...
TEST_CASE (
"conformance: print_original with single token returns token slice"
,
"[samasa][conformance][incremental]"
)
 {
...
TEST_CASE (
"conformance: recovery_makes_progress_v<insert_missing_token<V>> is true"
,
"[samasa][conformance][recovery]"
)
 {
...
TEST_CASE (
"conformance: insert_missing_token makes_progress member is true"
,
"[samasa][conformance][recovery]"
)
 {
...
TEST_CASE (
"conformance: validate_grammar detects recovery_no_progress"
,
"[samasa][conformance][recovery]"
)
 {
...
TEST_CASE (
"conformance: recovery_no_progress issue has error severity"
,
"[samasa][conformance][recovery]"
)
 {
...
TEST_CASE (
"conformance: grammar_valid<G> false when recovery_no_progress present"
,
"[samasa][conformance][recovery]"
)
 {
...
TEST_CASE (
"conformance: FOLLOW fixed-point — fp_a FOLLOW contains op_plus"
,
"[samasa][conformance][follow]"
)
 {
...
TEST_CASE (
"conformance: FOLLOW fixed-point — fp_b FOLLOW contains semi"
,
"[samasa][conformance][follow]"
)
 {
