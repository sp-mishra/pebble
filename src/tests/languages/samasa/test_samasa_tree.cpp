...
TEST_CASE (
"green_tree: build from event_stream produces non-empty tree"
,
"[samasa][tree]"
)
 {
...
TEST_CASE (
"green_tree: root node exists after build"
,
"[samasa][tree]"
)
 {
...
TEST_CASE (
"green_tree: root span covers both tokens"
,
"[samasa][tree]"
)
 {
...
TEST_CASE (
"green_tree: root child count matches emitted tokens"
,
"[samasa][tree]"
)
 {
...
TEST_CASE (
"green_tree: structural_hash is non-zero"
,
"[samasa][tree]"
)
 {
...
TEST_CASE (
"green_tree: structural_hash stability — same events same hash"
,
"[samasa][tree]"
)
 {
...
TEST_CASE (
"green_tree: different source produces different hash"
,
"[samasa][tree]"
)
 {
...
TEST_CASE (
"green_tree: empty event_stream produces empty tree"
,
"[samasa][tree]"
)
 {
...
TEST_CASE (
"red_tree: not built when build_red_tree=false (default)"
,
"[samasa][tree]"
)
 {
...
TEST_CASE (
"red_tree: build() from green_tree succeeds and is non-empty"
,
"[samasa][tree]"
)
 {
...
TEST_CASE (
"red_tree: root node's parent is null"
,
"[samasa][tree]"
)
 {
...
TEST_CASE (
"red_tree: child nodes have correct parent red_id"
,
"[samasa][tree]"
)
 {
