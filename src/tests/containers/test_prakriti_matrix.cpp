...
TEST_CASE("prakriti: ga::nrm2_sq matches manual squared length", "[prakriti][matrix]") {
...
TEST_CASE("prakriti: ga::axpy matches scalar XPBD correction", "[prakriti][matrix][xpbd]") {
...
TEST_CASE("prakriti: compute backend types exist in prakriti namespace", "[prakriti][backends]") {
