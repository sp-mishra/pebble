...
TEST_CASE("XPBD distance constraint pulls stretched edge toward rest length", "[prakriti][xpbd]") {
    Rig r;
...
TEST_CASE("damage accumulates and fractures over-stretched edge", "[prakriti][damage]") {
    Rig r;
...
TEST_CASE("damage does nothing below yield", "[prakriti][damage]") {
    Rig r;
    Index a = r.add({0.0f, 0.0f}, 0);
