...
TEST_CASE (
"akruti::Mat2 aliases ga::StaticMatrix<float,2,2>"
,
"[akruti][matrix]"
)
 {
...
TEST_CASE (
"akruti::Mat2 element access via (r,c)"
,
"[akruti][matrix]"
)
 {
...
TEST_CASE (
"akruti::make_rotation2d correctness"
,
"[akruti][matrix]"
)
 {
...
TEST_CASE (
"akruti::Mat2 * Vec2 bridge operator"
,
"[akruti][matrix]"
)
 {
...
TEST_CASE (
"akruti::Mat2 identity and inverse round-trip"
,
"[akruti][matrix]"
)
 {
...
TEST_CASE (
"akruti::Mat2 near-singular determinant"
,
"[akruti][matrix]"
)
 {
...
TEST_CASE (
"akruti::Mat2 is zero-heap (stack-only)"
,
"[akruti][matrix]"
)
 {
