...
TEST_CASE("Akruti: MultiGridSpatialHash for high-scale entities", "[akruti][spatial_hash][multigrid]") {
    ...
    akruti::AABB<float> box1{pebble::math::vec2{0, 0}, pebble::math::vec2{1, 1}};
    akruti::AABB<float> box2{pebble::math::vec2{0.5f, 0.5f}, pebble::math::vec2{1.5f, 1.5f}};
    akruti::AABB<float> box3{pebble::math::vec2{100, 100}, pebble::math::vec2{101, 101}};
    ...
    mg.query(akruti::AABB<float>{pebble::math::vec2{0, 0}, pebble::math::vec2{0.8f, 0.8f}}, [&](uint32_t id) {
