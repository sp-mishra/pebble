...
TEST_CASE (
"gati::Mat2 aliases ga::StaticMatrix<float,2,2>"
,
"[gati][matrix]"
)
 {
...
TEST_CASE (
"ga::quad_form_2d matches hand-computed effective mass"
,
"[gati][matrix][physics]"
)
 {
...
TEST_CASE (
"ga::quad_form_2d static body (inv_mass=0, inv_inertia=0)"
,
"[gati][matrix][physics]"
)
 {
...
TEST_CASE (
"ga::axpy position correction two-body"
,
"[gati][matrix][physics]"
)
 {
...
TEST_CASE (
"gati::Mat2 identity and matrix multiply"
,
"[gati][matrix]"
)
 {
