...
TEST_CASE("Network with ReLU and Sigmoid activations") {
    BrainGenome genome;
    genome.topology_type = TopologyType::FeedForward;
...
TEST_CASE("EvolutionaryProcess runs generations and tracks best genome") {
...
TEST_CASE("GenomeSerializer round-trips correctly") {
