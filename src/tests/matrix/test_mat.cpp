...
TEST_CASE (
"Mat: auto-select dense for small matrices"
,
"[mat][selection]"
)
 {
...
TEST_CASE (
"Mat: mutable element access throws on sparse"
,
"[mat][element_access]"
)
 {
...
TEST_CASE (
"Mat: const operator() returns element for dense"
,
"[mat][element_access][dense]"
)
 {
...
TEST_CASE (
"Mat: as_dense returns non-null for dense"
,
"[mat][as_dense]"
)
 {
...
TEST_CASE (
"Mat: as_sparse returns non-null for sparse"
,
"[mat][as_sparse]"
)
 {
...
TEST_CASE (
"Mat: maybe_adapt with NoAdaptorPolicy returns nullopt"
,
"[mat][adapt]"
)
 {
...
TEST_CASE (
"Mat: info() returns correct dimensions"
,
"[mat][info]"
)
 {
...
TEST_CASE (
"Mat: usage_stats initially zero"
,
"[mat][usage_stats]"
)
 {
...
TEST_CASE (
"Mat: inspect free function matches info()"
,
"[mat][inspect]"
)
 {
...
TEST_CASE (
"Mat: construct from existing Dense"
,
"[mat][construct_dense]"
)
 {
...
TEST_CASE (
"Mat: construct from existing Sparse (CSR)"
,
"[mat][construct_sparse]"
)
 {
...
TEST_CASE (
"ga::MatInfo: inspect StaticMatrix"
,
"[mat][inspect_static]"
)
 {
