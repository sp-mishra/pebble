...
TEST_CASE (
"Field: construction and channel access"
,
"[field][channels]"
)
 {
...
TEST_CASE (
"Field: channel(c) out of bounds throws"
,
"[field][channels]"
)
 {
...
TEST_CASE (
"Field: laplacian_ch produces correct size"
,
"[field][laplacian]"
)
 {
...
TEST_CASE (
"Field: grad_ch on constant field → zero gradient"
,
"[field][gradient]"
)
 {
...
TEST_CASE (
"Field: advect with zero velocity → no change"
,
"[field][advect]"
)
 {
...
TEST_CASE (
"Field: diffuse reduces peak value"
,
"[field][diffuse]"
)
 {
...
TEST_CASE (
"FluidField: type alias has 3 channels"
,
"[field][fluid]"
)
 {
...
TEST_CASE (
"PaintField: type alias channels"
,
"[field][paint]"
)
 {
