...
TEST_CASE (
"Grid2D: construction and element access"
,
"[stencil][grid2d]"
)
 {
...
TEST_CASE (
"laplacian: zero field → zero laplacian"
,
"[stencil][laplacian]"
)
 {
...
TEST_CASE (
"laplacian: quadratic field f=x^2+y^2 → Δf = 4/h^2 * h^2 = 4 (2nd order)"
,
"[stencil][laplacian]"
)
 {
...
TEST_CASE (
"gradient: constant field → zero gradient"
,
"[stencil][gradient]"
)
 {
...
TEST_CASE (
"divergence: zero velocity field → zero divergence"
,
"[stencil][divergence]"
)
 {
...
TEST_CASE (
"jacobi_diffuse: mass conservation"
,
"[stencil][diffuse]"
)
 {
...
TEST_CASE (
"advect_semilagrangian: shape preservation (zero velocity)"
,
"[stencil][advect]"
)
 {
