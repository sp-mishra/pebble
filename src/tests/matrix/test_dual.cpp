...
TEST_CASE (
"Dual: multiplication chain rule"
,
"[dual][autodiff]"
)
 {
...
TEST_CASE (
"Dual: grad_vec for multivariate f"
,
"[dual][autodiff][grad_vec]"
)
 {
...
TEST_CASE (
"Dual: N=2 independent variables"
,
"[dual][autodiff][multivariable]"
)
 {
...
TEST_CASE (
"Dual: comparison uses value only"
,
"[dual][autodiff]"
)
 {
...
TEST_CASE (
"hessian_vec: quadratic exactness ∇²f·v = A v"
,
"[dual][autodiff][hvp]"
)
 {
...
TEST_CASE (
"hessian: dense matches analytic + symmetric"
,
"[dual][autodiff][hvp]"
)
 {
...
TEST_CASE (
"hessian_vec: nonlinear column parity with hessian"
,
"[dual][autodiff][hvp]"
)
 {
