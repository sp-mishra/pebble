...
TEST_CASE (
"eig_sym: eigenvalues of 1D Laplacian are positive"
,
"[eigen][eig_sym]"
)
 {
...
TEST_CASE (
"eig_sym: eigenvectors are orthonormal"
,
"[eigen][eig_sym][orthonormal]"
)
 {
    Matrix<double> A(3, 3);
...
TEST_CASE (
"svd: singular values of 3×2 matrix"
,
"[eigen][svd]"
)
 {
...
TEST_CASE (
"svd: U and Vt are orthogonal"
,
"[eigen][svd][orthogonal]"
)
 {
    Matrix<double> A(4, 3);
...
TEST_CASE (
"rsvd: truncated k=2 on 5×5 rank-2 matrix"
,
"[eigen][rsvd]"
)
 {
...
TEST_CASE (
"power_iteration: dominant eigenvalue of diag matrix"
,
...
TEST_CASE (
"lanczos_eig: largest eigenvalue of Laplacian"
,
"[eigen][lanczos]"
)
 {
