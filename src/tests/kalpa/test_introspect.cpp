...
// ===========================================================================
TEST_CASE (
"kalpa: NoTelemetry is a zero-size solver member"
,
"[kalpa][introspect][zero-overhead]"
)
 {
...
// ===========================================================================
TEST_CASE (
"kalpa: FullTrace stores rows in order"
,
"[kalpa][introspect][trace]"
)
 {
...
TEST_CASE (
"kalpa: solver runs with a FullTrace sink attached"
,
"[kalpa][introspect][trace]"
)
 {
...
// ===========================================================================
TEST_CASE (
"kalpa: Callback runs once per iteration and sees descent"
,
"[kalpa][introspect][callback]"
)
 {
    auto prob = make_problem<double>(Quad{});
    std::size_t calls = 0;
...
// ===========================================================================
TEST_CASE (
"kalpa: explain formats a diagnosis with a hint"
,
"[kalpa][introspect][diagnosis]"
)
 {
...
// ===========================================================================
TEST_CASE (
"kalpa: telemetry does not alter the optimum"
,
"[kalpa][introspect]"
)
 {
...
TEST_CASE (
"kalpa: SparseTrace records sparsely and preserves order"
,
"[kalpa][introspect][trace]"
)
 {
