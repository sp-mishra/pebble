...
struct BentShape {
    ...
    [[nodiscard]] AABB<Scalar> aabb() const noexcept {
        ...
        return AABB<Scalar>{pebble::math::vec2(box.lo[0] - pad, box.lo[1] - pad),
...
struct TaperedShape {
    ...
    [[nodiscard]] AABB<Scalar> aabb() const noexcept {
        ...
        return AABB<Scalar>{pebble::math::vec2(box.lo[0] * max_scale, box.lo[1]),
...
struct SquashStretchShape {
    ...
    [[nodiscard]] AABB<Scalar> aabb() const noexcept {
        ...
        return AABB<Scalar>{pebble::math::vec2(box.lo[0] * sx, box.lo[1] * sy),
