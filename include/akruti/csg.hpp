...
[[nodiscard]] inline CsgPtr csg_union(CsgPtr a, CsgPtr b) {
    auto n = std::make_unique<CsgNode>();
    n->is_leaf = false; n->op = CsgOp::Union; n->a = std::move(a); n->b = std::move(b);
    return n;
}
[[nodiscard]] inline CsgPtr csg_subtract(CsgPtr a, CsgPtr b) {
    auto n = std::make_unique<CsgNode>();
    n->is_leaf = false; n->op = CsgOp::Subtract; n->a = std::move(a); n->b = std::move(b);
    return n;
}
[[nodiscard]] inline CsgPtr csg_intersect(CsgPtr a, CsgPtr b) {
    auto n = std::make_unique<CsgNode>();
    n->is_leaf = false; n->op = CsgOp::Intersect; n->a = std::move(a); n->b = std::move(b);
    return n;
}
[[nodiscard]] inline CsgPtr csg_smooth_union(CsgPtr a, CsgPtr b, Scalar k) {
    auto n = std::make_unique<CsgNode>();
    n->is_leaf = false; n->op = CsgOp::SmoothUnion; n->a = std::move(a); n->b = std::move(b); n->k = k;
    return n;
}
[[nodiscard]] inline CsgPtr csg_chamfer_union(CsgPtr a, CsgPtr b, Scalar k) {
    auto n = std::make_unique<CsgNode>();
    n->is_leaf = false; n->op = CsgOp::ChamferUnion; n->a = std::move(a); n->b = std::move(b); n->k = k;
    return n;
}
[[nodiscard]] inline CsgPtr csg_shell(CsgPtr a, Scalar thickness) {
    auto n = std::make_unique<CsgNode>();
    n->is_leaf = false; n->op = CsgOp::Shell; n->a = std::move(a); n->k = thickness;
    return n;
}
[[nodiscard]] inline CsgPtr csg_morph(CsgPtr a, CsgPtr b, Scalar t) {
    auto n = std::make_unique<CsgNode>();
    n->is_leaf = false; n->op = CsgOp::Morph; n->a = std::move(a); n->b = std::move(b); n->k = t;
    return n;
}
