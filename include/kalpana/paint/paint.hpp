...
public:
    ...
    [[nodiscard]] const std::optional<spectral::SpectralColor>& spectral_color() const noexcept { return spectral_color_; }
    ...
    [[nodiscard]] const std::optional<spectral::SpectralGradient>& spectral_grad() const noexcept { return spectral_grad_; }
