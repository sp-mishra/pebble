    ...
    struct StateColumn {
        ...
        void update(std::span<State> states,
            ...
            for (std::size_t i = 0; i < n; ++i) {
                ...
                const Scalar dMA = activation_rate * u * s.resting_motor_units - fatigue_rate * s.active_motor_units;
                const Scalar dMR = recovery_rate * s.fatigued_motor_units - activation_rate * u * s.resting_motor_units;
