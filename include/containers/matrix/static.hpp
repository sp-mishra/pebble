...
namespace ga {
    ...
    // -----------------------------------------------------------------------
    template <typename T>
    using Mat2 = StaticMatrix<T, 2, 2>;
    template <typename T>
    using Mat3 = StaticMatrix<T, 3, 3>;
    template <typename T>
    using Mat4 = StaticMatrix<T, 4, 4>;
    template <typename T>
    using Vec2 = StaticMatrix<T, 2, 1>;
    template <typename T>
    using Vec3 = StaticMatrix<T, 3, 1>;
    template <typename T>
    using Vec4 = StaticMatrix<T, 4, 1>;
