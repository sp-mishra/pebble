    ...
    namespace presets {
        [[nodiscard]] constexpr MaterialPreset steel() noexcept {
            return {
                "steel",
                {
                    .density = 0.98f, .stiffness = 0.95f, .damping = 0.05f, .brittleness = 0.30f, .roughness = 0.20f,
                    .thickness = 0.70f
                }
            };
        }
        ...
        [[nodiscard]] constexpr MaterialPreset glass() noexcept {
            return {
                "glass",
                {
                    .density = 0.60f, .stiffness = 0.85f, .damping = 0.02f, .brittleness = 0.95f, .roughness = 0.10f,
                    .thickness = 0.20f
                }
            };
        }
        ...
        [[nodiscard]] constexpr MaterialPreset wood() noexcept {
            return {
                "wood",
                {
                    .density = 0.40f, .stiffness = 0.45f, .damping = 0.35f, .brittleness = 0.50f, .roughness = 0.60f,
                    .thickness = 0.80f
                }
            };
        }
        ...
        [[nodiscard]] constexpr MaterialPreset rubber() noexcept {
            return {
                "rubber",
                {
                    .density = 0.50f, .stiffness = 0.05f, .damping = 0.90f, .brittleness = 0.02f, .roughness = 0.80f,
                    .thickness = 0.50f
                }
            };
        }
        ...
        [[nodiscard]] constexpr MaterialPreset cloth() noexcept {
            return {
                "cloth",
                {
                    .density = 0.10f, .stiffness = 0.02f, .damping = 0.95f, .brittleness = 0.05f, .roughness = 0.90f,
                    .thickness = 0.05f
                }
            };
        }
        ...
        [[nodiscard]] constexpr MaterialPreset concrete() noexcept {
            return {
                "concrete",
                {
                    .density = 0.95f, .stiffness = 0.90f, .damping = 0.20f, .brittleness = 0.70f, .roughness = 0.80f,
                    .thickness = 1.00f
                }
            };
        }
        ...
        [[nodiscard]] constexpr MaterialPreset ceramic() noexcept {
            return {
                "ceramic",
                {
                    .density = 0.65f, .stiffness = 0.80f, .damping = 0.08f, .brittleness = 0.88f, .roughness = 0.30f,
                    .thickness = 0.25f
                }
            };
        }
        ...
        [[nodiscard]] constexpr MaterialPreset wood_hollow() noexcept {
            return {
                "wood_hollow",
                {
                    .density = 0.25f, .stiffness = 0.38f, .damping = 0.18f, .brittleness = 0.40f, .roughness = 0.55f,
                    .thickness = 0.15f
                }
            };
        }
