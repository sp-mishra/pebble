    ...
    struct Clip {
        ...
        void sample_into(Transform& tr, Scalar time) const noexcept {
            ...
            for (const auto& trk : tracks) {
                ...
                switch (trk.channel) {
                case Channel::PosX: tr.position[0] = v;
                    break;
                case Channel::PosY: tr.position[1] = v;
                    break;
                case Channel::Angle: tr.angle = v;
                    break;
                case Channel::ScaleX: tr.scale[0] = v;
                    break;
                case Channel::ScaleY: tr.scale[1] = v;
                    break;
                }
            }
        }
