...
namespace pebble::drishya::widgets {
    ...
    struct Stack : WidgetBase {
        ...
        Stack& align(Align a) noexcept {
            style_.align_items = a;
            return *this;
        }

        Stack& justify(Justify j) noexcept {
            style_.justify_content = j;
            return *this;
        }

        Stack& padding(float p) noexcept {
            style_.padding = Edges{p, p, p, p};
            return *this;
        }

        Stack& padding(Edges e) noexcept {
            style_.padding = e;
            return *this;
        }

        Stack& grow(float g) noexcept {
            style_.flex_grow = g;
            return *this;
        }

        Stack& width(SizeSpec w) noexcept {
            style_.width = w;
            return *this;
        }

        Stack& height(SizeSpec h) noexcept {
            style_.height = h;
            return *this;
        }
    };
    ...
    struct Panel : WidgetBase {
        ...
        Panel& fill(std::uint32_t argb) noexcept {
            background = argb;
            return *this;
        }

        Panel& rounded(float r) noexcept {
            radius = r;
            return *this;
        }

        Panel& pad(float p) noexcept {
            style_.padding = Edges{p, p, p, p};
            return *this;
        }

        Panel& axis(Axis a) noexcept {
            style_.axis = a;
            return *this;
        }
