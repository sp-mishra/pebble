...
namespace pebble::drishya::widgets {
    ...
    struct Label : WidgetBase {
        ...
        Label& set_color(std::uint32_t c) noexcept {
            color = c;
            return *this;
        }

        Label& size(float fs) noexcept {
            font_size = fs;
            return *this;
        }
    ...
    struct Progress : WidgetBase {
        ...
        Progress& set_value(float v) noexcept {
            value = clamp01(v);
            return *this;
        }
    ...
    struct Spinner : WidgetBase {
        ...
        Spinner() noexcept {
            style_.width = SizeSpec::Px(16.0f);
            style_.height = SizeSpec::Px(16.0f);
        }
