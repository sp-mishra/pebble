...
Discard all pulses while preserving thread-local execution lineage. Use it when code must propagate a trace context
without routing events; omit `PulseScope`
